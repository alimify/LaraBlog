    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    Edit Post
                    <small>Edit existing post here</small>
                </h2>
            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input name="title" type="text" id="title" class="form-control" placeholder="Enter Post Title" value="{{$post->title}}">
                                    </div>
                                </div>
                                <label for="image">Featured Image</label>
                                <br>
                                <img src="{{asset('storage/post/'.$post->image)}}" width="120px">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input name="image" type="file" id="image" class="form-control">
                                    </div>
                                </div>
                                <input type="checkbox" id="publish" class="filled-in" name="publish" value="1" {{$post->status ? 'checked' : ''}}>
                                ...
                                <select name="categories[]" class="form-control show-tick" multiple>
                                    @foreach($categories as $category)
                                        <option value="{{$category->id}}"
                                                {{in_array($category->id,$postCategories)
